...
Hlavním cílem je připravit datově podložený pohled na zákaznickou retenci a vytvořit management dashboard pro podporu retenčních rozhodnutí.

# Plánovaný rozsah dat

Projekt pracuje se syntetickým relačním datasetem přibližně v tomto rozsahu:
...
Hlavní transformační vrstvou je **SQL Server**.

SQL část zahrnuje zejména:
...
Analýza se soustředí zejména na:
